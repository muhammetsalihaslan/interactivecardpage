    ...
    <div>
      <div className="relative">
        ...
        <div className="absolute flex sm:flex-col flex-col-reverse  gap-y-6 ms-[10rem]  sm:ms-[10px] -mt-[20rem] sm:-mt-[35rem] xl:ms-[15rem] p-3">
          ...
          <div className="bg-[url('/images/bg-card-back.png')] bg-cover w-[380px] h-[220px] sm:w-[350px] sm:h-[180px] lg:w-[400px] lg:h-[220px] rounded-md -ms-[5rem] sm:-ms-0 md:ms-[5rem] text-md  mt-[1rem]">
